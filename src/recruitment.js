export const DEPARTMENTS = ["研发部", "项目部", "外联部", "组织部", "产品部", "实干青年部"];
export const STATUSES = ["待审核", "已面试", "通过", "未通过"];
...
export function createRecruitmentRecord(data, createdAt) {
...
export function updateApplicationStatus(records, id, status) {
